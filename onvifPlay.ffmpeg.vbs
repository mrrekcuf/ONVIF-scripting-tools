' by mr rekcuf
' vbscript to play live stream from onvif camera
' Usage:
' cscript /nolog onvifQuery.vbs camera_IP userID password profile_token
'

if wscript.arguments.Count < 4 then 
	wscript.echo
	wscript.echo "Usage: "
	wscript.echo " cscript /nologo " &wscript.scriptName  &" camera_IP userID password profile_token"
	wscript.echo
	wscript.quit
end if
...
cmdline = objShell.CurrentDirectory &"\ffplay -rtsp_transport tcp -i " &chr(34) &suri &chr(34)
