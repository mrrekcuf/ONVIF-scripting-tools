...
' Usage:
' cscript /nolog onvifQuery.vbs camera_IP userID password
'

if wscript.arguments.Count < 3 then 
	wscript.echo
	wscript.echo "Usage: "
	wscript.echo " cscript /nologo " &wscript.scriptName  &" camera_IP userID password"
	wscript.echo
	wscript.quit
end if
	...
	If Err.Number = 0 Then 
		...
		y = 0 
  		For Each item In items
			...
			.send Replace(requestGetStreamUri, "REPLACEPROFILE", profile(x))

'			wscript.echo
'			wscript.echo Replace(requestGetStreamUri, "REPLACEPROFILE", profile(x))
'			wscript.echo
'			wscript.echo
